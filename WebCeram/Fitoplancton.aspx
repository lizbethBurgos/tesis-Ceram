...
&nbsp;<asp:Label ID="lbSearchNa" runat="server" ForeColor="Red"></asp:Label>
                <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <br />
                <asp:Label ID="lbSearchCo" runat="server" ForeColor="Red"></asp:Label>
            </td>
            <td>
                &nbsp;</td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <asp:GridView ID="gvSearchCell0" runat="server" CellPadding="4" ForeColor="#333333" 
                    GridLines="None" AutoGenerateColumns="False">
                    <AlternatingRowStyle BackColor="White" />
                    <Columns>
                        <asp:BoundField DataField="Cod_spec" HeaderText="Código" />
                        <asp:BoundField DataField="Name_spec" HeaderText="Nombre" />
                    </Columns>
                    <EditRowStyle BackColor="#7C6F57" />
                    <FooterStyle BackColor="#1C5E55" Font-Bold="True" ForeColor="White" />
                    <HeaderStyle BackColor="#1C5E55" Font-Bold="True" ForeColor="White" />
